        ...
        "service.DashboardData": {
            ...
            "properties": {
                "attention_items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.DashboardAttention"
                    }
                },
                "onboarding": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.DashboardStep"
                    }
                },
                "recent_work": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.DashboardRecentWork"
                    }
                },
                "summary": {
